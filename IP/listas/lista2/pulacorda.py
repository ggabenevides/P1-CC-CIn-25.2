...
for rodada in range(1, qtde_rodadas + 1):
    ...
    while pulo_atual < aposta or num_tropecos < 3:
        x = aposta - pulo_atual
        # AJEITAR ESSA PARTE 
    ...
    #pontuando
    if pulo_atual == aposta or pulo_atual > aposta:
        if rodada == qtde_rodadas:
